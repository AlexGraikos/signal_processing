...
\begin{minipage}{0.48\textwidth}
	\centering
	\includegraphics[width=\textwidth, trim={0 5cm 0 5cm}, clip]{fig/filtered_wt.pdf}
\end{minipage}
\begin{minipage}{0.48\textwidth}
	\centering
	\includegraphics[width=\textwidth, trim={0 5cm 0 5cm}, clip]{fig/wt_energy.pdf}
\end{minipage}
\vfill
...
\begin{minipage}{0.48\textwidth}
	\centering
	\includegraphics[width=\textwidth, trim={0 5cm 0 5cm}, clip]{fig/autocorr_wt.pdf}
	(α)
\end{minipage}
\begin{minipage}{0.48\textwidth}
	\centering
...
\begin{minipage}{0.48\textwidth}
	\centering
	\includegraphics[width=\textwidth, trim={0 5cm 0 5cm}, clip]{fig/112l1_detected_peaks.pdf}
\end{minipage}
\begin{minipage}{0.48\textwidth}
	\centering
	\includegraphics[width=\textwidth, trim={0 5cm 0 5cm}, clip]{fig/112l2_detected_peaks.pdf}
\end{minipage}
\end{figure}
